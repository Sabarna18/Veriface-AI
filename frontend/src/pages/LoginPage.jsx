...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store token and validate authentication
      // through AuthContext
      ...
      // isAuthenticated changes after login,
      // and useEffect redirects to /classrooms.
    } catch (err) {
          ...
          <div className="px-8 py-8">
            ...
            <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
              ...
              <p className="text-sm text-blue-800">
                Students do not need to login and can access the application
                directly.
              </p>
            </div>
